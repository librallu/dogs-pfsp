...
if __name__ == "__main__":
    ...
    for t in types:
        ...
        print("instance & ALGirtct & shake-LS & IBS\_alpha & IBS\_walpha \\\\")
        print("\\hline")
        for (n,m) in t:
            for i in I:
                ...
                print("TA{} / {} & {} \\\\".format(id_inst, k.replace("_","\\_"), " & ".join(apply_bold(format_values(tab), bold_flag))))
                id_inst += 1
        print("\\end{tabular}")
    ...
    #         # ])
    # # headers = ["instance", "IGrms", "VBIH", "IGbob", "IBSgap", "IBS_wfrontalpha"]
    # # print(tab)
